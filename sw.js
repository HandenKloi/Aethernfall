...
const CORE = ['./assets/art/portal.svg', './physics.js?v=' + VERSION, './art.js?v=' + VERSION, './assets/art/characters.webp', './assets/art/objects.webp', './assets/art/terrain.webp', './', './index.html', './style.css?v=' + VERSION, './audio.js?v=' + VERSION, './persistence.js?v=' + VERSION, './quests.js?v=' + VERSION, './combat.js?v=' + VERSION, './game.js?v=' + VERSION, './manifest.json?v=' + VERSION, './assets/icon-192.png', './assets/icon-512.png', ...['grass', 'dirt', 'stone', 'water', 'wood', 'foliage', 'rune'].map(n => './assets/textures/' + n + '.png')];
